function oldBrowserWarning(){if(document.all&&!document.addEventListener){var e=new Array,t=-1;e[++t]='<p id="w-browser-warning" class="w-error" style="margin:0;">',e[++t]="You are using an old browser which is unsupported. Some features may not work correctly. ",e[++t]='Consider <a href="http://www.whatbrowser.org/intl/en_uk/">upgrading</a> to a modern browser. ',e[++t]='<span id="w-dismiss-browser-warning" class="w-false-link">Dismiss.</span> ',e[++t]="</p>";var n=document.createElement("div");n.innerHTML=e.join(""),document.body.insertBefore(n,document.body.childNodes[0])}document.getElementById("w-dismiss-browser-warning")&&(document.getElementById("w-dismiss-browser-warning").onclick=function(){var e=document.getElementById("w-browser-warning");e.parentNode.removeChild(e)})}window.attachEvent&&window.attachEvent("onload",oldBrowserWarning);var wModal,datePickerOptions={show_icon:!1},RecaptchaOptions={theme:"custom",custom_theme_widget:"recaptcha_widget"};$(document).ready(function(){$(".w-breadcrumb li:last-child a").click(function(e){e.preventDefault()}),$(".w-file-input-button").click(function(){$(this).prev("input[type=text]").prev("input[type=file]").trigger("click")}),$(".w-file-input").click(function(){$(this).prev("input[type=file]").trigger("click")}),$("input[type=file]").change(function(){var e=$(this).val().replace(/\\/g,"/");e=e.split("/").pop(),$(this).next("input[type=text]").val(e)})});
